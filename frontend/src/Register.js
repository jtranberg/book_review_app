...
import { FontAwesomeIcon} from "@fortawesome/react-fontawesome";
     ...
     setErrMsg('');
      ...
      const handleSubmit = async (e) => {
         e.preventDefault();
         //if button enabled through hack
         const v1 = USER_REGEX.test(user);    //security
...
//            <h1> Success!</h1>
//            <p>
//                 <a href="https://docs.google.com/document/d/1iGOXsVlaHPF1I7RiFPhdDv4_K-RHXmBlmblEqcTHugI/edit">Sign In</a>
//            </p>
//        </section>
//        ) : (
        <section>
